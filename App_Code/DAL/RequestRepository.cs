...
namespace CRMP.DAL
{
    public class RequestRepository
    {
        ...
        public PagedResult<Request> GetPaged(RequestFilter filter)
        {
            ...
            string dataSql = BuildDetailQuery() + $" {where} {orderBy} OFFSET {offset} ROWS FETCH NEXT {filter.PageSize} ROWS ONLY";
        ...
        private static Request MapRequest(DataRow row) => new Request
        {
            RequestId         = OracleHelper.ToInt(row["REQUEST_ID"]),
