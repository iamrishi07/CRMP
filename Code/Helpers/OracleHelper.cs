...
namespace CRMP.Helpers
{
    ...
    public static class OracleHelper
    {
        ...
        {
            return (value == DBNull.Value || value == null) ? defaultVal : Convert.ToInt32(value);
        }

        public static int? ToNullableInt(object value)
        {
            return (value == DBNull.Value || value == null) ? (int?)null : Convert.ToInt32(value);
        }

        public static string ToString(object value, string defaultVal = "")
        {
            return (value == DBNull.Value || value == null) ? defaultVal : value.ToString();
        }

        public static bool ToBool(object value, bool defaultVal = false)
        {
            return (value == DBNull.Value || value == null) ? defaultVal : Convert.ToInt32(value) == 1;
        }

        public static DateTime? ToNullableDateTime(object value)
        {
            return (value == DBNull.Value || value == null) ? (DateTime?)null : Convert.ToDateTime(value);
        }

        public static DateTime ToDateTime(object value, DateTime defaultVal = default(DateTime))
        {
            return (value == DBNull.Value || value == null) ? defaultVal : Convert.ToDateTime(value);
        }

        public static decimal ToDecimal(object value, decimal defaultVal = 0)
        {
            return (value == DBNull.Value || value == null) ? defaultVal : Convert.ToDecimal(value);
        }
        ...
        {
            return new OracleParameter(name, OracleDbType.Int32) { Value = value.HasValue ? (object)value.Value : DBNull.Value };
        }

        public static OracleParameter ParamStr(string name, string value, int size = 4000)
        {
            return new OracleParameter(name, OracleDbType.Varchar2, size) { Value = (object)value ?? DBNull.Value };
        }

        public static OracleParameter ParamClob(string name, string value)
        {
            return new OracleParameter(name, OracleDbType.Clob) { Value = (object)value ?? DBNull.Value };
        }

        public static OracleParameter ParamDate(string name, DateTime? value)
        {
            return new OracleParameter(name, OracleDbType.TimeStamp) { Value = value.HasValue ? (object)value.Value : DBNull.Value };
        }

        public static OracleParameter ParamBool(string name, bool value)
        {
            return new OracleParameter(name, OracleDbType.Int32) { Value = value ? 1 : 0 };
        }
    }
}
