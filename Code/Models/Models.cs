...
namespace CRMP.Models
{
    ...
    public class RoleDelegation
    {
        ...
        {
            get { return IsActive && DateTime.Today >= StartDate && DateTime.Today <= EndDate; }
        }
    }
    ...
    public class FormField
    {
        ...
        {
            get { return ConditionalParentFieldId.HasValue; }
        }
    }
    ...
    public class Request
    {
        ...
        {
            get { return SlaDeadline.HasValue ? (SlaDeadline.Value - DateTime.Now).TotalHours : 0; }
        }
    ...
    public class Notification
    {
        ...
        public string TimeAgo
        {
            get
            {
                ...
                if (ts.TotalMinutes < 60) return ((int)ts.TotalMinutes).ToString() + "m ago";
                if (ts.TotalHours < 24)   return ((int)ts.TotalHours).ToString() + "h ago";
